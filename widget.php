...
?>
    <div>
        <p>
            ...
            <input class="widefat" type="text" name="<?php echo $this->get_field_name('st_cat_title')?>" value="<?php echo esc_attr($instance['st_cat_title']); ?>" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('st_cat_categories'); ?>"><?php _e('Choose category :'); ?></label>
            <select id="<?php echo $this->get_field_id('st_cat_categories'); ?>" class="widefat" name="<?php echo $this->get_field_name('st_cat_categories'); ?>">
					<?php echo implode('', $this->get_cat( $instance['st_cat_categories'] )); ?>
            </select>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('st_cat_templates'); ?>"><?php _e('Choose Template :'); ?></label>
            <select id="<?php echo $this->get_field_id('st_cat_templates'); ?>" class="widefat" name="<?php echo $this->get_field_name('st_cat_templates'); ?>">
        ...
        <p>
            ...
            <input class="widefat" size="5" type="text" name="<?php echo $this->get_field_name('st_cat_limit')?>" value="<?php echo esc_attr($instance['st_cat_limit']); ?>" />
        </p>
        <p>
            <input type="checkbox" class="checkbox" name="<?php echo $this->get_field_name('st_cat_dropdown')?>"<?php checked( $instance['st_cat_dropdown'] ); ?> />
            <label for="<?php echo $this->get_field_id('st_cat_dropdown'); ?>"><?php _e('Display as dropdown'); ?></label>
        </p>
        <p>
            <input type="checkbox" class="checkbox" name="<?php echo $this->get_field_name('st_cat_count')?>"<?php checked( $instance['st_cat_count'] ); ?> />
            <label for="<?php echo $this->get_field_id('st_cat_count'); ?>"><?php _e('Show post counts'); ?></label>
        </p>
        <p>
            <input type="checkbox" class="checkbox" name="<?php echo $this->get_field_name('st_cat_hideempty')?>"<?php checked( $instance['st_cat_hideempty'] ); ?> />
            <label for="<?php echo $this->get_field_id('st_cat_hideempty'); ?>"><?php _e('Hide Empty Categories'); ?></label>
        </p>
        <p>
            <input type="checkbox" class="checkbox" name="<?php echo $this->get_field_name('st_cat_hierarchy')?>"<?php checked( $instance['st_cat_hierarchy'] ); ?> />
            <label for="<?php echo $this->get_field_id('st_cat_hierarchy'); ?>"><?php _e('Hide Hierarchy'); ?></label>
        </p>		
    </div>
<?php
    }
