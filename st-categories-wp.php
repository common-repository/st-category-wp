...
?>
        <div id="st-categories" class="st-categories">
            ...
            <div class="main box left">
                <h3 class="box-title"><div class="dashicons dashicons-admin-generic"></div><?php _e('Custom Css', 'st-categories-wp')?></h3>
                <div class="content">
...
<?php
    ...
    */
    ...
    function copyright() {
?>
        <h3 class="box-title"><div class="dashicons dashicons-sos"></div><?php _e('Abouts', 'st-categories-wp')?></h3>
        <div class="st-box">
        	...
        	<div class="st-row st-links">
        		<div class="col col-8 links">
        			<ul>
        				<li>
        					<a href="http://beautiful-templates.com/" target="_blank"><?php _e('Home', 'st-categories-wp')?></a>
        				</li>
        				<li>
        					<a href="http://beautiful-templates.com/amember/" target="_blank"><?php _e('Submit Ticket', 'st-categories-wp')?></a>
        				</li>
        				<li>
        					<a href="http://beautiful-templates.com/evo/forum/" target="_blank"><?php _e('Forum', 'st-categories-wp')?></a>
        				</li>
        				<li>
        					<?php add_thickbox(); ?>
        					<a href="<?php echo plugins_url( '/doc/index.html', __FILE__ ); ?>?TB_iframe=true&width=1000&height=600" class="thickbox"><?php _e('Document', 'st-categories-wp')?></a>
        				</li>
        			</ul>
        		</div>
